...
interface ClientInterface
{
     ...
     *
     * @param mixed $request array of parameters for MarketplaceWebService_Model_GetReportRequestListByNextTokenRequest
     *     request or MarketplaceWebService_Model_GetReportRequestListByNextTokenRequest object itself
     *
     ...
     *
     * @param mixed $request array of parameters for MarketplaceWebService_Model_UpdateReportAcknowledgementsRequest
     *     request or MarketplaceWebService_Model_UpdateReportAcknowledgementsRequest object itself
     *
     ...
     *     MarketplaceWebService_Model_GetFeedSubmissionListByNextTokenRequest request or
     *     MarketplaceWebService_Model_GetFeedSubmissionListByNextTokenRequest object itself
     *
     ...
     *
     * @param mixed $request array of parameters for
     *     MarketplaceWebService_Model_GetReportScheduleListByNextTokenRequest request or
     *     MarketplaceWebService_Model_GetReportScheduleListByNextTokenRequest object itself
     *
     ...
     *
     * @param mixed $request array of parameters for MarketplaceWebService_Model_GetReportListByNextTokenRequest
     *     request
