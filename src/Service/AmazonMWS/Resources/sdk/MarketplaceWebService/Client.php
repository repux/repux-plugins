...
namespace App\Service\AmazonMWS\Resources\sdk\MarketplaceWebService;
...
class Client implements ClientInterface
{
    ...
    /**
     * @param $amazonLogRequests
     */
    public function setAmazonLogRequests($amazonLogRequests)
    {
        $this->amazonLogRequests = $amazonLogRequests;
    }
     ...
     *
     * @param mixed $request array of parameters for Model\GetReportRequest request
     * or Model\GetReportRequest object itself
     *
     * @see Model\GetReport
     * @return Model\GetReportResponse Model\GetReportResponse
     *
     * @throws ClientException
     */
    public function getReport($request)
    {
        if (!$request instanceof Model\GetReportRequest) {
            $request = new Model\GetReportRequest($request);
        }

        $httpResponse = $this->invoke($this->convertGetReport($request), $request->getReport());
        $response = Model\GetReportResponse::fromXML($httpResponse['ResponseBody']);
     ...
     *
     * @param mixed $request array of parameters for Model\GetReportScheduleCountRequest request
     * or Model\GetReportScheduleCountRequest object itself
     *
     * @see Model\GetReportScheduleCount
     * @return Model\GetReportScheduleCountResponse Model\GetReportScheduleCountResponse
     *
     * @throws ClientException
     */
    public function getReportScheduleCount($request)
    {
        if (!$request instanceof Model\GetReportScheduleCountRequest) {
            $request = new Model\GetReportScheduleCountRequest($request);
        }

        $httpResponse = $this->invoke($this->convertGetReportScheduleCount($request));
        $response = Model\GetReportScheduleCountResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\GetReportRequestListByNextTokenRequest request
     * or Model\GetReportRequestListByNextTokenRequest object itself
     *
     * @see Model\GetReportRequestListByNextToken
     * @return Model\GetReportRequestListByNextTokenResponse Model\GetReportRequestListByNextTokenResponse
     *
     * @throws ClientException
     */
    public function getReportRequestListByNextToken($request)
    {
        if (!$request instanceof Model\GetReportRequestListByNextTokenRequest) {
            $request = new Model\GetReportRequestListByNextTokenRequest($request);
        }
        $httpResponse = $this->invoke($this->convertGetReportRequestListByNextToken($request));
        $response = Model\GetReportRequestListByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\UpdateReportAcknowledgementsRequest request
     * or Model\UpdateReportAcknowledgementsRequest object itself
     *
     * @see Model\UpdateReportAcknowledgements
     * @return Model\UpdateReportAcknowledgementsResponse Model\UpdateReportAcknowledgementsResponse
     *
     * @throws ClientException
     */
    public function updateReportAcknowledgements($request)
    {
        if (!$request instanceof Model\UpdateReportAcknowledgementsRequest) {
            $request = new Model\UpdateReportAcknowledgementsRequest($request);
        }
        $httpResponse = $this->invoke($this->convertUpdateReportAcknowledgements($request));
        $response = Model\UpdateReportAcknowledgementsResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\SubmitFeedRequest request
     * or Model\SubmitFeedRequest object itself
     *
     * @see Model\SubmitFeed
     * @return Model\SubmitFeedResponse Model\SubmitFeedResponse
     *
     * @throws ClientException
     */
    public function submitFeed($request)
    {
        if (!$request instanceof Model\SubmitFeedRequest) {
            $request = new Model\SubmitFeedRequest($request);
        }
        $httpResponse = $this->invoke($this->convertSubmitFeed($request), $request->getFeedContent(),
            $request->getContentMd5());
        $response = Model\SubmitFeedResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\GetReportCountRequest request
     * or Model\GetReportCountRequest object itself
     *
     * @see Model\GetReportCount
     * @return Model\GetReportCountResponse Model\GetReportCountResponse
     *
     * @throws ClientException
     */
    public function getReportCount($request)
    {
        if (!$request instanceof Model\GetReportCountRequest) {
            $request = new Model\GetReportCountRequest($request);
        }
        $httpResponse = $this->invoke($this->convertGetReportCount($request));
        $response = Model\GetReportCountResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\GetFeedSubmissionListByNextTokenRequest request
     * or Model\GetFeedSubmissionListByNextTokenRequest object itself
     *
     * @see Model\GetFeedSubmissionListByNextToken
     * @return Model\GetFeedSubmissionListByNextTokenResponse Model\GetFeedSubmissionListByNextTokenResponse
     *
     * @throws ClientException
     */
    public function getFeedSubmissionListByNextToken($request)
    {
        if (!$request instanceof Model\GetFeedSubmissionListByNextTokenRequest) {
            $request = new Model\GetFeedSubmissionListByNextTokenRequest($request);
        }
        $httpResponse = $this->invoke($this->convertGetFeedSubmissionListByNextToken($request));
        $response = Model\GetFeedSubmissionListByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\CancelFeedSubmissionsRequest request
     * or Model\CancelFeedSubmissionsRequest object itself
     *
     * @see Model\CancelFeedSubmissions
     * @return Model\CancelFeedSubmissionsResponse Model\CancelFeedSubmissionsResponse
     *
     * @throws ClientException
     */
    public function cancelFeedSubmissions($request)
    {
        if (!$request instanceof Model\CancelFeedSubmissionsRequest) {
            $request = new Model\CancelFeedSubmissionsRequest($request);
        }
        $httpResponse = $this->invoke($this->convertCancelFeedSubmissions($request));
        $response = Model\CancelFeedSubmissionsResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\RequestReportRequest request
     * or Model\RequestReportRequest object itself
     *
     * @see Model\RequestReport
     * @return Model\RequestReportResponse Model\RequestReportResponse
     *
     * @throws ClientException
     */
    public function requestReport($request)
    {
        if (!$request instanceof Model\RequestReportRequest) {
            $request = new Model\RequestReportRequest($request);
        }

        $httpResponse = $this->invoke($this->convertRequestReport($request));
        $response = Model\RequestReportResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\GetFeedSubmissionCountRequest request
     * or Model\GetFeedSubmissionCountRequest object itself
     *
     * @see Model\GetFeedSubmissionCount
     * @return Model\GetFeedSubmissionCountResponse Model\GetFeedSubmissionCountResponse
     *
     * @throws ClientException
     */
    public function getFeedSubmissionCount($request)
    {
        if (!$request instanceof Model\GetFeedSubmissionCountRequest) {
            $request = new Model\GetFeedSubmissionCountRequest($request);
        }
        $httpResponse = $this->invoke($this->convertGetFeedSubmissionCount($request));
        $response = Model\GetFeedSubmissionCountResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\CancelReportRequestsRequest request
     * or Model\CancelReportRequestsRequest object itself
     *
     * @see Model\CancelReportRequests
     * @return Model\CancelReportRequestsResponse Model\CancelReportRequestsResponse
     *
     * @throws ClientException
     */
    public function cancelReportRequests($request)
    {
        if (!$request instanceof Model\CancelReportRequestsRequest) {
            $request = new Model\CancelReportRequestsRequest($request);
        }
        $httpResponse = $this->invoke($this->convertCancelReportRequests($request));
        $response = Model\CancelReportRequestsResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\GetReportListRequest request
     * or Model\GetReportListRequest object itself
     *
     * @see Model\GetReportList
     * @return Model\GetReportListResponse Model\GetReportListResponse
     *
     * @throws ClientException
     */
    public function getReportList($request)
    {
        if (!$request instanceof Model\GetReportListRequest) {
            $request = new Model\GetReportListRequest($request);
        }
        $httpResponse = $this->invoke($this->convertGetReportList($request));
        $response = Model\GetReportListResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\GetFeedSubmissionResultRequest request
     * or Model\GetFeedSubmissionResultRequest object itself
     *
     * @see Model\GetFeedSubmissionResult
     * @return Model\GetFeedSubmissionResultResponse Model\GetFeedSubmissionResultResponse
     *
     * @throws ClientException
     */
    public function getFeedSubmissionResult($request)
    {
        if (!$request instanceof Model\GetFeedSubmissionResultRequest) {
            $request = new Model\GetFeedSubmissionResultRequest($request);
        }
        $httpResponse = $this->invoke($this->convertGetFeedSubmissionResult($request),
            $request->getFeedSubmissionResult());
        $response = Model\GetFeedSubmissionResultResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\GetFeedSubmissionListRequest request
     * or Model\GetFeedSubmissionListRequest object itself
     *
     * @see Model\GetFeedSubmissionList
     * @return Model\GetFeedSubmissionListResponse Model\GetFeedSubmissionListResponse
     *
     * @throws ClientException
     */
    public function getFeedSubmissionList($request)
    {
        if (!$request instanceof Model\GetFeedSubmissionListRequest) {
            $request = new Model\GetFeedSubmissionListRequest($request);
        }
        $httpResponse = $this->invoke($this->convertGetFeedSubmissionList($request));
        $response = Model\GetFeedSubmissionListResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\GetReportRequestListRequest request
     * or Model\GetReportRequestListRequest object itself
     *
     * @see Model\GetReportRequestList
     * @return Model\GetReportRequestListResponse Model\GetReportRequestListResponse
     *
     * @throws ClientException
     */
    public function getReportRequestList($request)
    {
        if (!$request instanceof Model\GetReportRequestListRequest) {
            $request = new Model\GetReportRequestListRequest($request);
        }
        $httpResponse = $this->invoke($this->convertGetReportRequestList($request));
        $response = Model\GetReportRequestListResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\GetReportScheduleListByNextTokenRequest request
     * or Model\GetReportScheduleListByNextTokenRequest object itself
     *
     * @see Model\GetReportScheduleListByNextToken
     * @return Model\GetReportScheduleListByNextTokenResponse Model\GetReportScheduleListByNextTokenResponse
     *
     * @throws ClientException
     */
    public function getReportScheduleListByNextToken($request)
    {
        if (!$request instanceof Model\GetReportScheduleListByNextTokenRequest) {
            $request = new Model\GetReportScheduleListByNextTokenRequest($request);
        }
        $httpResponse = $this->invoke($this->convertGetReportScheduleListByNextToken($request));
        $response = Model\GetReportScheduleListByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\GetReportListByNextTokenRequest request
     * or Model\GetReportListByNextTokenRequest object itself
     *
     * @see Model\GetReportListByNextToken
     * @return Model\GetReportListByNextTokenResponse Model\GetReportListByNextTokenResponse
     *
     * @throws ClientException
     */
    public function getReportListByNextToken($request)
    {
        if (!$request instanceof Model\GetReportListByNextTokenRequest) {
            $request = new Model\GetReportListByNextTokenRequest($request);
        }
        $httpResponse = $this->invoke($this->convertGetReportListByNextToken($request));
        $response = Model\GetReportListByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\ManageReportScheduleRequest request
     * or Model\ManageReportScheduleRequest object itself
     *
     * @see Model\ManageReportSchedule
     * @return Model\ManageReportScheduleResponse Model\ManageReportScheduleResponse
     *
     * @throws ClientException
     */
    public function manageReportSchedule($request)
    {
        if (!$request instanceof Model\ManageReportScheduleRequest) {
            $request = new Model\ManageReportScheduleRequest($request);
        }
        $httpResponse = $this->invoke($this->convertManageReportSchedule($request));
        $response = Model\ManageReportScheduleResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\GetReportRequestCountRequest request
     * or Model\GetReportRequestCountRequest object itself
     *
     * @see Model\GetReportRequestCount
     * @return Model\GetReportRequestCountResponse Model\GetReportRequestCountResponse
     *
     * @throws ClientException
     */
    public function getReportRequestCount($request)
    {
        if (!$request instanceof Model\GetReportRequestCountRequest) {
            $request = new Model\GetReportRequestCountRequest($request);
        }
        $httpResponse = $this->invoke($this->convertGetReportRequestCount($request));
        $response = Model\GetReportRequestCountResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *
     * @param mixed $request array of parameters for Model\GetReportScheduleListRequest request
     * or Model\GetReportScheduleListRequest object itself
     *
     * @see Model\GetReportScheduleList
     * @return Model\GetReportScheduleListResponse Model\GetReportScheduleListResponse
     *
     * @throws ClientException
     */
    public function getReportScheduleList($request)
    {
        if (!$request instanceof Model\GetReportScheduleListRequest) {
            $request = new Model\GetReportScheduleListRequest($request);
        }
        $httpResponse = $this->invoke($this->convertGetReportScheduleList($request));
        $response = Model\GetReportScheduleListResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    ...
    private function getContentMd5($data)
    {
        ...
        if (is_string($data)) {
            /**
             * Weak cryptographic hashes such as md5 cannot guarantee data integrity.
             * Should not be used in security-critical contexts.
             */
            ...
            do {
                try {
                    ...
                    switch ($httpStatus) {
                        ...
                        case 500:
                        case 503:
                            $errorResponse = Model\ErrorResponse::fromXML($response['ResponseBody']);
                    ...
                    throw new ClientException(['Exception' => $e, 'Message' => $e->getMessage()]);
                }
            } while ($shouldRetry);
        } catch (ClientException $se) {
            throw $se;
        } catch (\Exception $t) {
            throw new ClientException(['Exception' => $t, 'Message' => $t->getMessage()]);
        }
    ...
    private function performRequest($action, array $converted, $dataHandle = null, $contentMd5 = null)
    {
        ...
        $responseHeaderMetadata = new Model\ResponseHeaderMetadata(
        ...
        if ($this->amazonLogRequests && $this->output) {
            $this->output->writeln((new \DateTime())->format('c').' '.$httpResponse);
        }
...
//            CURLOPT_VERBOSE => $this->amazonLogRequests,
        ];
    }
    ...
    private function configureCurlOptions($action, array $converted, $streamHandle = null, $contentMd5 = null)
    {
        ...
        if ($requestType == RequestType::POST_UPLOAD) {
            ...
            if (is_null($streamHandle) || !is_resource($streamHandle)) {
                throw new ClientException(
                    ['Message' => 'Missing stream resource.']);
            }
