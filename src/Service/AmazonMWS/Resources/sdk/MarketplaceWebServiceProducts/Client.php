...
namespace App\Service\AmazonMWS\Resources\sdk\MarketplaceWebServiceProducts;

use App\Service\AmazonMWS\Resources\sdk\MarketplaceWebServiceProducts\Model;
use App\App\Entity\ChannelAmazon;
use Symfony\Component\Console\Output\OutputInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Client is an implementation of MarketplaceWebServiceProducts
 *
 */
class Client implements ClientInterface
{
     ...
     *
     * @param mixed $request array of parameters for Model\GetCompetitivePricingForASIN request or
     *     Model\GetCompetitivePricingForASIN object itself
     *
     * @see Model\GetCompetitivePricingForASINRequest
     ...
     *
     * @param mixed $request array of parameters for Model\GetCompetitivePricingForSKU request or
     *     Model\GetCompetitivePricingForSKU object itself
     *
     * @see Model\GetCompetitivePricingForSKURequest
     ...
     *
     * @param mixed $request array of parameters for Model\GetLowestOfferListingsForASIN request or
     *     Model\GetLowestOfferListingsForASIN object itself
     *
     * @see Model\GetLowestOfferListingsForASINRequest
     ...
     * SellerId and SKU.
     *
     * @param mixed $request array of parameters for Model\GetLowestOfferListingsForSKU request or
     *     Model\GetLowestOfferListingsForSKU object itself
     *
     * @see Model\GetLowestOfferListingsForSKURequest
     ...
     *     ASIN.
     *
     * @param mixed $request array of parameters for Model\GetLowestPricedOffersForASIN request or
     *     Model\GetLowestPricedOffersForASIN object itself
     *
     * @see Model\GetLowestPricedOffersForASINRequest
     * @return Model\GetLowestPricedOffersForASINResponse
     *
     * @throws ClientException
     */
    public function getLowestPricedOffersForASIN($request)
    {
        if (!($request instanceof Model\GetLowestPricedOffersForASINRequest)) {
            $request = new Model\GetLowestPricedOffersForASINRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'GetLowestPricedOffersForASIN';
        $httpResponse = $this->_invoke($parameters);

        $response = Model\GetLowestPricedOffersForASINResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     *     SellerId and SKU.
     *
     * @param mixed $request array of parameters for Model\GetLowestPricedOffersForSKU request or
     *     Model\GetLowestPricedOffersForSKU object itself
     *
     * @see Model\GetLowestPricedOffersForSKURequest
     * @return Model\GetLowestPricedOffersForSKUResponse
     *
     * @throws ClientException
     */
    public function getLowestPricedOffersForSKU($request)
    {
        if (!($request instanceof Model\GetLowestPricedOffersForSKURequest)) {
            $request = new Model\GetLowestPricedOffersForSKURequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'GetLowestPricedOffersForSKU';
        $httpResponse = $this->_invoke($parameters);

        $response = Model\GetLowestPricedOffersForSKUResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     * given ASIN.
     *
     * @param mixed $request array of parameters for Model\GetMatchingProduct request or Model\GetMatchingProduct
     *     object itself
     *
     * @see Model\GetMatchingProductRequest
     ...
     *
     * @param mixed $request array of parameters for Model\GetMatchingProductForId request or
     *     Model\GetMatchingProductForId object itself
     *
     * @see Model\GetMatchingProductForIdRequest
     ...
     *
     * @param mixed $request array of parameters for Model\GetMyPriceForASIN request or Model\GetMyPriceForASIN object
     *     itself
     *
     * @see Model\GetMyPriceForASINRequest
     ...
     * <!-- Wrong doc in current code -->
     *
     * @param mixed $request array of parameters for Model\GetMyPriceForSKU request or Model\GetMyPriceForSKU object
     *     itself
     *
     * @see Model\GetMyPriceForSKURequest
     ...
     * the MarketplaceId and ASIN.
     *
     * @param mixed $request array of parameters for Model\GetProductCategoriesForASIN request or
     *     Model\GetProductCategoriesForASIN object itself
     *
     * @see Model\GetProductCategoriesForASINRequest
     ...
     * the SellerId and SKU.
     *
     * @param mixed $request array of parameters for Model\GetProductCategoriesForSKU request or
     *     Model\GetProductCategoriesForSKU object itself
     *
     * @see Model\GetProductCategoriesForSKURequest
     ...
     *
     * @param mixed $request array of parameters for Model\GetServiceStatus request or Model\GetServiceStatus object
     *     itself
     *
     * @see Model\GetServiceStatusRequest
     ...
     *
     * @param mixed $request array of parameters for Model\ListMatchingProducts request or Model\ListMatchingProducts
     *     object itself
     *
     * @see Model\ListMatchingProductsRequest
...
//        curl_setopt($ch, CURLOPT_VERBOSE, $this->amazonLogRequests);
     ...
     * We need to split the raw response string by 2 'CRLF's.  2 'CRLF's should indicate the separation of the response
     * header from the response body.  However in our case we have some circumstances (certain client proxies) that
     * result in multiple responses concatenated.  We could encounter a response like
     *
     ...
     * ... body ..
     *
     * This method will throw away extra response status lines and attempt to find the first full response headers and
     * body
     *
    ...
    private function _extractHeadersAndBody($response)
    {
        ...
        if ($this->amazonLogRequests && $this->output) {
            $this->output->writeln((new \DateTime())->format('c').' '.$body);
        }
