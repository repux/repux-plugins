...
namespace App\Service\AmazonMWS\sdk\MarketplaceWebService\Model;

use App\Service\AmazonMWS\sdk\MarketplaceWebService\ClientModel;
 ...
 * <li>MarketplaceIdList: Model\IdList</li>
 ...
 * </ul>
 */
class SubmitFeedRequest extends ClientModel
{
    const MAX_QUOTA = 15;
    const HOURLY_QUOTA = 30;
    const RESTORE_RATE = 120; //seconds
    ...
    {
        self::$DEFAULT_CONTENT_TYPE = new Model\ContentType(
    ...
    {
        $marketplaceIdList = new Model\IdList();
