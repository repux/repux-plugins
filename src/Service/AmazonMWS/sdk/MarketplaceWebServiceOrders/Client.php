...
use App\Service\AmazonMWS\sdk\MarketplaceWebServiceOrders\Model;
use App\Entity\AmazonChannel;
use Symfony\Component\Console\Output\OutputInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Client is an implementation of MarketplaceWebServiceOrders
 *
 */
class Client implements ClientInterface
{
    ...
    {
        if (!($request instanceof Model\GetOrderRequest)) {
            $request = new Model\GetOrderRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'GetOrder';
        $httpResponse = $this->_invoke($parameters);

        $response = Model\GetOrderResponse::fromXML($httpResponse['ResponseBody']);
     ...
     * @return Model\ListOrderItemsResponse
     *
     * @throws ClientException
     */
    public function listOrderItems($request)
    {
        if (!($request instanceof Model\ListOrderItemsRequest)) {
            $request = new Model\ListOrderItemsRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'ListOrderItems';
        $httpResponse = $this->_invoke($parameters);

        $response = Model\ListOrderItemsResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     * @return Model\ListOrderItemsByNextTokenResponse
     *
     * @throws ClientException
     */
    public function listOrderItemsByNextToken($request)
    {
        if (!($request instanceof Model\ListOrderItemsByNextTokenRequest)) {
            $request = new Model\ListOrderItemsByNextTokenRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'ListOrderItemsByNextToken';
        $httpResponse = $this->_invoke($parameters);

        $response = Model\ListOrderItemsByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    ...
    {
        if (!($request instanceof Model\ListOrdersRequest)) {
            $request = new Model\ListOrdersRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'ListOrders';
        $httpResponse = $this->_invoke($parameters);

        $response = Model\ListOrdersResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
     ...
     * @return Model\ListOrdersByNextTokenResponse
     *
     * @throws ClientException
     */
    public function listOrdersByNextToken($request)
    {
        if (!($request instanceof Model\ListOrdersByNextTokenRequest)) {
            $request = new Model\ListOrdersByNextTokenRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'ListOrdersByNextToken';
        $httpResponse = $this->_invoke($parameters);

        $response = Model\ListOrdersByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
