...
namespace App\Service\AmazonMWS\sdk\MarketplaceWebServiceOrders\Model;

use App\Service\AmazonMWS\sdk\MarketplaceWebServiceOrders\ClientModel;
 ...
 * </ul>
 */
class GetServiceStatusResult extends ClientModel
{
    public function __construct($data = null)
    {
        $this->_fields = [
            ...
            'Messages' => ['FieldValue' => [], 'FieldType' => ['Message'], 'ListMemberName' => 'Message'],
        ];
